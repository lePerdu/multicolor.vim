...
" < https://github.com/lePerdu/multicolor.vim/blob/master/README.md >
" for more information.)
if !exists("g:multicolor_termcolors")
  let g:multicolor_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:multicolor_terminal_italics")
...
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from multicolor#extend_highlight
  ...
  if g:multicolor_terminal_italics == 0
...
function! multicolor#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! multicolor#extend_highlight(group, style)
...
call s:h("Constant", { "fg": s:light_green }) " any constant
...
call s:h("Statement", { "fg": s:yellow }) " any statement
call s:h("Conditional", { "fg": s:yellow }) " if, then, else, endif, switch, etc.
...
call s:h("Exception", { "fg": s:yellow }) " try, catch, throw
call s:h("PreProc", { "fg": s:dark_orange }) " generic Preprocessor
call s:h("Include", { "fg": s:blue }) " preprocessor #include
call s:h("Define", { "fg": s:purple }) " preprocessor #define
call s:h("Macro", { "fg": s:purple }) " same as Define
call s:h("PreCondit", { "fg": s:dark_orange }) " preprocessor #if, #else, #endif, etc.
...
call s:h("Special", { "fg": s:light_purple }) " any special symbol
...
call s:h("Cursor", { "fg": s:black, "bg": s:orange }) " the character under the cursor
...
call s:h("IncSearch", { "fg": s:dark_yellow, "bg": s:comment_grey }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
...
call s:h("Question", { "fg": s:dark_orange }) " hit-enter prompt and yes/no questions
...
call s:h("QuickFixLine", { "fg": s:black, "bg": s:dark_yellow }) " Current quickfix item in the quickfix window.
